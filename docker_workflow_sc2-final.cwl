...
steps:
  ...
  notify_participants:
    run: https://raw.githubusercontent.com/Sage-Bionetworks/ChallengeWorkflowTemplates/v2.0/notification_email.cwl
    in:
      - id: submissionid
        source: "#submissionId"
      - id: synapse_config
  ...
  get_docker_config:
    run: https://raw.githubusercontent.com/Sage-Bionetworks/ChallengeWorkflowTemplates/v2.0/get_docker_config.cwl
    in:
      - id: synapse_config
        source: "#synapseConfig"
    out: 
  ...
  run_docker:
    ...
    in:
      ...
      - id: synapse_config
        source: "#synapseConfig"
      - id: input_dir
        valueFrom: "/home/vchung/final_sc2"
      - id: docker_script
        default:
          class: File
  ...
  upload_results:
    run: https://raw.githubusercontent.com/Sage-Bionetworks/ChallengeWorkflowTemplates/v2.0/upload_to_synapse.cwl
    in:
      - id: infile
  ...
  score_email:
    run: https://raw.githubusercontent.com/Sage-Bionetworks/ChallengeWorkflowTemplates/develop/score_email.cwl
    in:
      - id: submissionid
        source: "#submissionId"
      - id: synapse_config
